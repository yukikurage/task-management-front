...
export function TaskCard({
  ...
  return (
    <button
      className="bg-white border border-border rounded-xl p-5 w-[194px] h-64 flex flex-col gap-2 items-start text-left shadow-lg shadow-black/5 cursor-pointer hover:shadow-md transition-all"
      onClick={onClick}
      type="button"
    >
